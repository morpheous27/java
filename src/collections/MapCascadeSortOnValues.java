...
public class MapCascadeSortOnValues {
	...
	public static void main(String[] args) {
		...
		map.put("100", new Employee(400, "saxena", "CB"));
		map.put("550", new Employee(200, "ashley", "CCB"));
		...
		Collections.sort(list, new MapCascadeSortOnValues.EmployeeComparator());
